...
const byte betrModeP    =   A0;//Analog input to determine the operating mode. Will only be at
//Program start read in!
const byte resModeP     =   A1;//Reset CV values ​​+ center position servos
...
//#define NOACK //Activate this line if there is no HW to read CV (DCC only).
